...
!(function webpackMissingModule() { var e = new Error("Cannot find module '../../node_modules/perfect-scrollbar/dist/perfect-scrollbar'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
(function () {
    ...
    if (isWindows) {
        ...
        if (_node_modules_jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_0__('.main-panel').length != 0) {
            var ps = new !(function webpackMissingModule() { var e = new Error("Cannot find module '../../node_modules/perfect-scrollbar/dist/perfect-scrollbar'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('.main-panel', {
                wheelSpeed: 2,
        ...
        if (_node_modules_jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_0__('.sidebar .sidebar-wrapper').length != 0) {
            var ps1 = new !(function webpackMissingModule() { var e = new Error("Cannot find module '../../node_modules/perfect-scrollbar/dist/perfect-scrollbar'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('.sidebar .sidebar-wrapper');
            _node_modules_jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_0__('.table-responsive').each(function () {
                var ps2 = new !(function webpackMissingModule() { var e = new Error("Cannot find module '../../node_modules/perfect-scrollbar/dist/perfect-scrollbar'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(_node_modules_jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_0__(this)[0]);
            });
        }
