...
## Security
Everything was created with security as the highest priority. When you handle user data, this is one of the most important steps. We created the web api with special authentication for the login part. The web api also have CORS only enable for specific domains.
