...
module.exports = {
  ...
  entry: ['./src/index.htm', './src/scss/styles.scss', './src/js/index.ts', './src/dashboard.html','./src/map.html','./src/notifications.html','./src/tables.html','./src/upgrade.html','./src/user.html',],
  module: {
